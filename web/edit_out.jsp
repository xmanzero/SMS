                ...
                <div id="r_col">
                    <%
                        ...
                        if (id != null) {
                            ...
                            ResultSet res = connect.excuteQuery("Select PhoneNumber,CalledNumber,FullContent from all_sms_queue_out where id='" + id + "'");
                            out.print("<table id='edittb'>");
                            out.print("<form action='ProcessEdit_out.jsp' method='post'>");
                            while (res.next()) {
